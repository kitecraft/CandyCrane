...
#define MCP_BUTTON_CONTROLLER_INTERUPT_PIN 13
...
#define DOLLY_STEPPER_PIN_1 2
#define DOLLY_STEPPER_PIN_2 0
#define DOLLY_STEPPER_PIN_3 4
#define DOLLY_STEPPER_PIN_4 16
...
#define DOLLY_LIMIT_SWITCH_PIN 25
