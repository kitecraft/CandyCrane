...
#define CRANE_CONTROL_PRIORITY tskIDLE_PRIORITY+2
#define CRANE_CONTROL_QUEUE_HANDLER_PRIORITY tskIDLE_PRIORITY+1
#define CANDY_CRANE_COMMS_HANDLER_PRIORITY tskIDLE_PRIORITY+3
...
#define DOLLY_STEPS_PER_MM 47.4
#define DOLLY_MAXIMUM_DISTANCE 245
...
#define TOWER_MAXIMUM_DISTANCE 215
