...
#define DOLLY_SPEED_STEPS_SECOND 800
#define DOLLY_ACCEL_STEPS_SECOND 800
#define DOLLY_CALIBRATION_SPEED 500

#define ROPE_BARREL_STEPPER_PIN_1 26 //12
#define ROPE_BARREL_STEPPER_PIN_2 27 //14
#define ROPE_BARREL_STEPPER_PIN_3 14 //27
#define ROPE_BARREL_STEPPER_PIN_4 12 //26
#define ROPE_BARREL_STEPS_PER_MM 12  //24.3 //48.6
#define ROPE_BARREL_MAXIMUM_DISTANCE 1000
#define ROPE_BARREL_SPEED_STEPS_SECOND 300
#define ROPE_BARREL_ACCEL_STEPS_SECOND 300
#define ROPE_BARREL_CALIBRATION_SPEED 100
#define BUCKET_DEFAULT_DISTANCE 60.0
...
#define TOWER_SPEED_STEPS_SECOND 300
#define TOWER_ACCEL_STEPS_SECOND 300
#define TOWER_CALIBRATION_SPEED 150
